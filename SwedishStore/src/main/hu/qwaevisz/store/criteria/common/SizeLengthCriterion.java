...
public class SizeLengthCriterion extends DoubleRange implements FurnitureCriterion {

	public SizeLengthCriterion(Double minValue, Double maxValue) {
		super(minValue, maxValue);
	}

	@Override
	public boolean isValid(AbstractFurniture furniture) {
		return super.isValid(furniture.getSize().getLength());
	}
